package com.spt.sp_template.mapper;
...
public interface UserMapper {
    ...
    @Insert("insert into user (username, password, name, phone, email, address, avatar , role)" +
            " values " +
            "(#{username},#{password},#{name},#{phone},#{email},#{address},#{avatar} ,#{role})")
    ...
    int selectByCountPage(@Param("username") String username,@Param("name") String name);
